/**
 * Shared SVG marks. Previously these were copy-pasted (the logo) or drawn with
 * divergent paths (the social icons) across Hero, AppNav, and LandingSections.
 * One implementation each, sized via a `size` prop.
 */
